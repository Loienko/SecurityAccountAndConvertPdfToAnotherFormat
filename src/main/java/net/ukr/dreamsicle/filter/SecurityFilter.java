...
import net.ukr.dreamsicle.request.UserRoleRequestWrapper;
import net.ukr.dreamsicle.utils.AppUtils;
import net.ukr.dreamsicle.utils.SecurityUtils;
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
        ...
        if (SecurityUtils.isSecurityPage(request)) {
            ...
            if (!hasPermission) {
                ...
                req.getServletContext().getRequestDispatcher("/WEB-INF/JSP/accessDeniedView.jsp").forward(request, response);
                return;
            }
        }
